...
client key can be manually overrided with [`ConnectionSettingsBuilder::with_client_key()`]. Pairing
can be forced with [`ConnectionSettingsBuilder::with_forced_pairing()`].
